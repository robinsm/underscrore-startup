				...
				<a href="<?php echo $link; ?>" data-cy="services-link-<?php echo $loop_index; ?>">
					<div class="service" style="<?php echo $style; ?>">
						<div class="service_padding">
							...
							<div class="symbol">
								<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/dist/images/icons/vertical-line.svg"
									 alt=""/>
							</div>
							<div class="on_hover">
								<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/dist/images/icons/plus.svg"
									 alt=""/>
							</div>
